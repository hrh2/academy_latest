...
import {TbLetterB, TbLetterW} from "react-icons/tb";
      ...
      <div className="py-4 px-6">
        ...
        <div className="mb-12">
          ...
          <div className="my-8 flex flex-col gap-4">
            ...
            >
              ...
              <Button onClick={()=>handleLogout()} variant="outlined" color="red" fullWidth>
                Logout
              </Button>
          </div>
          {/*<a*/}
        ...
        <div className="text-center">
          ...
          <div className="mt-4 flex justify-center gap-2">
            <a
              href="https://www.instagram.com/_.byose._/"
              target="_black"
            >
            <Button
              variant="gradient"
            ...
            <a
              href="https://www.youtube.com/@this-is-byose"
              target="_black"
            >
            <Button
              variant="gradient"
